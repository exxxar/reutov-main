<template>
    <div class="test-block">
        ...
        <div class="test-main test-main-72 test-exercise-in-topical-diagnostic">
            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p
                        class="explanation-txt xplanation-txt-topical-diagnostic"
                    >
                        <b>Дано:</b><br />
                        <span>
                            Внимательно рассмотрите схему двухнейронных путей
                            лицевых нервов.
                        </span>
                    </p>
                </div>
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test62.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    <div class="test-explanation test-explanation-desc">
                        ...
                        >
                            <b>Дано:</b><br />
                            <span>
                                Внимательно рассмотрите схему двухнейронных
                                путей лицевых нервов.
                            </span>
                        </p>
                    </div>
                    <div class="test-explanation">
                        ...
                        >
                            <span>
                                На рисунке внизу вы видите двух больных. У
                                одного из них – центральное поражение левого
                                лицевого нерва, которое развилось вследствие
                                поражения центральных нейронов (на схеме
                                патологический очаг обозначен цифрой 1), а у
                                другого больного – периферическое поражение
                                лицевого нерва, возникшее при поражении
                                периферического нейрона в самом нерве (2).
                            </span>

                            <span>
                                Пораженные мышцы указаны штрихами.
                            </span>

                            <b class="last"
                                >Укажите цифрой патологический очаг.</b
                            >
                        </p>
                    </div>
                    ...
                    <ul class="compliance-list row">
                        <li
                            ...
                            :key="index"
                            class="col-6 compliance__item-input"
                        >
                            <div>
...
export default {
            ...
            answers: [
                {
                    ...
                    symbol: "А",
                    result: null,
                    img: "test-img/test62(1).png"
                },
                {
                    correct: "2",
                    symbol: "Б",
                    result: null,
                    img: "test-img/test62(2).png"
                }
            ]
        };
    },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "72");
        }
    },
    methods: {
