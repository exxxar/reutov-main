        ...
        <div class="test-wrapper">
            <div v-show="!loading" id="test" class="swiper test-swiper">
                <div class="swiper-wrapper">
                    ...
                    <!--                <div class="test-slider__btn swiper-button-next"></div>-->
                    <!--                <div class="test-slider__btn swiper-button-prev"></div>-->
                </div>
            </div>
            ...
            <button v-show="!loading && !completed" type="submit" style="color: white" class="test-button">
                Сдать тест
            </button>
        </div>
    </form>
...
<script>
import QuestionTest2 from "./questions/QuestionTest2";
import QuestionTest3 from "./questions/QuestionTest3";
import QuestionTest4 from "./questions/QuestionTest4";
import QuestionTest5 from "./questions/QuestionTest5";
import QuestionTest6 from "./questions/QuestionTest6";
import QuestionTest7 from "./questions/QuestionTest7";
import QuestionTest8 from "./questions/QuestionTest8";
import QuestionTest9 from "./questions/QuestionTest9";
import QuestionTest10 from "./questions/QuestionTest10";
import QuestionTest11 from "./questions/QuestionTest11";
import QuestionTest12 from "./questions/QuestionTest12";
import QuestionTest13 from "./questions/QuestionTest13";
import QuestionTest14 from "./questions/QuestionTest14";
import QuestionTest15 from "./questions/QuestionTest15";
