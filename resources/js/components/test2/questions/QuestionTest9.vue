        ...
        <div class="test-main test-exercise-in-topical-diagnostics">
            ...
            <div class="test-compliance">
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test17.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block" style="padding-left:5%">
                    ...
                    <div class="compliance-radio__block">
                        <div class="compliance-radio__elm">
...
export default {
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "9");
        }
    }
};
</script>
