            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>ДАНО</b><br />
                        у больного – полное поперечное поражение шейного
                        утолщения спинного мозга (С5-С8).
                    </p>
                </div>
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test19.png'"
                        alt="courses"
                    />
                </div>
...
export default {
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "11");
        }
    }
};
</script>
