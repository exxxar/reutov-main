            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>ДАНО</b><br />
                        полное поперечное поражение спинного мозга в области
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test14.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    ...
                    <p class="explanation-txt">
                        <span
                            >Укажите, какие сухожильные рефлексы исчезнут.</span
                        >
                    </p>
                    <div class="compliance-block">
...
export default {
    ...
    data() {
        return {
            ...
            correctAnswers: ["коленные рефлексы", "ахилловы рефлексы"]
        };
    },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "6");
        }
    }
};
</script>
