    ...
    <div class="test-block">
        ...
        <div class="test-main test-course-of-the-first-neurons">
            <div class="test-caption">
                <p>
                    Ход третьих нейронов
                    <span>
                    Опишите ход третьих нейронов поверхностной (<img
                    ...
                    Вспомните, пожалуйста, закон проекции частей нашего тела в
            ...
            <div class="test-compliance">
                ...
                <div class="compliance-img">
                    <img
                        style="max-width:100%"
                        :src="currentUrl + '/test-img/test36.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    <p class="compliance-txt">
                        А) III нейрон поверхностной <br />чувствительности
                    </p>
                    ...
                    <p class="compliance-txt">
                        Б) III нейрон глубокой и сложной <br />чувствительности
                    </p>
                    <ul class="compliance-list">
...
export default {
    ...
    data() {
        return {
            answers: [
                ...
                {
                    correct:
                        "Задняя центральная извилина коры больших полушарий головного мозга",
                    part: 0,
                    symbol: "4",
                    result: null
                },
                ...
                {
                    correct: "Задняя центральная извилина и кора теменной доли",
                    part: 1,
                    symbol: "4",
                    result: null
                }
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "35");
        },
        firstPart() {
