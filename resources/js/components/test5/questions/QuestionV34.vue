        ...
        <div class="test-main test-course-of-the-first-neurons">
            <div class="test-caption">
                <p>
                    Ход вторых нейронов
                    <span>
                    Опишите ход вторых нейронов поверхностной (<img
                        :src="currentUrl + '/test-img/icon3.png'"
                        alt="courses"
                    />) и глубокой (<img
                        :src="currentUrl + '/test-img/icon4.png'"
                        alt="courses"
                    />) чувствительностей, используя цифровые указатели рисунка.
                    Отметьте для себя, где они идут вместе.
                </span>
                </p>
            ...
            <div class="test-compliance">
                ...
                <div class="compliance-img">
                    <img
                        style="max-width:100%"
                        :src="currentUrl + '/test-img/test35.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    <p class="compliance-txt">
                        А) II нейрон поверхностной <br />чувствительности
                    </p>
                    ...
                    <p class="compliance-txt">
                        Б) II нейрон глубокой и сложной <br />чувствительности
                    </p>
                    <ul class="compliance-list">
...
export default {
    ...
    data() {
        return {
            answers: [
                ...
                {
                    correct: "Перекрест в передней серой спайке",
                    part: 0,
                    symbol: "2",
                    result: null
                },
                {
                    correct: "Боковой столб",
                    part: 0,
                    symbol: "3",
                    result: null
                },
                ...
                {
                    correct: "Ядра задних столбов",
                    part: 1,
                    symbol: "8",
                    result: null
                },
                {
                    correct: "Перекрест петли в продолговатом мозгу",
                    part: 1,
                    symbol: "9",
                    result: null
                },
                {
                    correct: "Lemniscus medialis в продолговатом мозгу",
                    part: 1,
                    symbol: "4",
                    result: null
                },
                {
                    correct: "Lemniscus medialis в варолиевом мосту",
                    part: 1,
                    symbol: "5",
                    result: null
                },
                {
                    correct: "Lemniscus medialis в ножке мозга",
                    part: 1,
                    symbol: "6",
                    result: null
                },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "34");
        },
        firstPart() {
