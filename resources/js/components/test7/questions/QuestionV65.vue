<template>
    <div class="test-block">
        ...
        <div
            class="test-main test-main-65 test-exercise-in-topical-diagnostics"
        >
            <div class="test-caption">
                <p>
                    Упражнение в топической диагностике
                    <span>
                    Назовите локализацию процесса при следующих нарушениях полей
                    зрения:
                </span>
                </p>
            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>Дано:</b><br/>
                        У больного – глухота на левое ухо
                        <b class="last">Примечание:</b>
                        вы, конечно знаете, что через мозжечок слуховые пути не
                        проходят! Перед вами ведь рисунок, то есть плоскостное
                        изображение!
                    </p>
                </div>
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test58.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    <div class="test-explanation">
                        <p class="explanation-txt test-explanation-desc">
                            <b>Дано:</b><br/>
                            У больного – глухота на левое ухо
                            <b class="last">Примечание:</b>
                            вы, конечно знаете, что через мозжечок слуховые пути
                            не проходят! Перед вами ведь рисунок, то есть
...
export default {
    ...
    data() {
        return {
            answers: [
                {
                    correct:
                        "в слуховом нерве или в самом ухе на стороне глухоты",
                    symbol: "А",
                    result: null,
                    description:
                        "Рассмотрите схему и назовите наиболее вероятную локализацию патологического процесса."
                }
            ]
        };
    },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "65");
        }
    },
    methods: {
