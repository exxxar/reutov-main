<template>
    <div class="test-block">
        ...
        <div class="test-main test-elements-of-the-visual-analyzer">
            <div class="test-caption">
                <p>
                    Анализаторы зрения, слуха и обоняния
                    <span>
                    Надписать элементы зрительного анализатора
                </span>
                </p>
            ...
            <div class="test-compliance">
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test54.png'"
                        alt="courses"
                        class="compliance-img__img"
                    />
                    <img
                        :src="currentUrl + '/test-img/test54-mob.png'"
                        alt="courses"
...
export default {
    ...
    data() {
        return {
            answers: [
                {
                    correct:
                        "Сетчатая оболочка глаза, рецепторы зрительного нерва",
                    symbol: "1",
                    result: null
                },
                {
                    correct: "Зрительный нерв",
                    symbol: "2",
                    result: null
                },
                {
                    correct: "Перекрест зрительных нервов",
                    symbol: "3",
                    result: null
                },
                {
                    correct: "Зрительный тракт",
                    symbol: "4",
                    result: null
                },
                {
                    correct: "Наружное коленчатое тело",
                    symbol: "6",
                    result: null
                },
                {
                    correct: "Верхние холмики четверохолмия",
                    symbol: "5",
                    result: null
                },
                {
                ...
                {
                    correct: "Пучок Грациоле в затылочной доле мозга",
                    symbol: "8",
                    result: null
                },
                {
                    correct: "Шпорная борозда",
                    symbol: "9",
                    result: null
                }
            ]
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "61");
        }
    },
    methods: {
