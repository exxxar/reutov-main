<template>
    <div class="test-block">
        ...
        <div class="test-main test-main-63">
            ...
            <div class="test-compliance">
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test56.png'"
                        alt="courses"
                    />
                </div>
...
export default {
    ...
    data() {
        return {
            answers: [
                {
                    correct:
                        "Левый зрительный тракт или пути II пары в кору слева",
                    symbol: "А",
                    result: null,
                    description: "Правосторонняя гемианопсия – …"
                },
                {
                    correct: "Внутренняя часть перекреста зрительных нервов",
                    symbol: "Б",
                    result: null,
                    description: "Битемпоральная гемианопсия – …"
                },
                {
                    correct: "Затылочная доля, область шпорной борозды (слева)",
                    symbol: "В",
                    result: null,
                    description: "Правосторонняя квадрантная гемианопсия – …"
                },
                {
                    correct: "Правый зрительный нерв",
                    symbol: "Г",
                    result: null,
                    description: "Амавроз справа – …"
                }
            ]
        };
    },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "63");
        }
    },
    methods: {
