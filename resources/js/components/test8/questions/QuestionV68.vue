<template>
    <div class="test-block">
        ...
        <div class="test-main test-main-68 test-exercise-in-topical-diagnostic">
            ...
            <div class="test-compliance">
                ...
                >
                    <p class="explanation-txt">
                        <b>Дано:</b><br />
                        Правый центр взора в мосту связывает VI пару справа и
                        III пару слева через задний продольный пучок (f. l. p.).
                    </p>
                </div>
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test59.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    <div class="test-explanation test-explanation-desc">
                        <p class="explanation-txt">
                            <b>Дано:</b><br />
                            Правый центр взора в мосту связывает VI пару справа
                            и III пару слева через задний продольный пучок (f.
                            l. p.).
                        </p>
                    </div>
...
export default {
            ...
            answers: [
                {
                    ...
                    result: null,
                    description:
                        "При раздражении правого центра взора в мосту глаза отводятся … (куда?)."
                },
                {
                    symbol: "Б",
                    result: null,
                    description:
                        "При поражении правого центра взора в мосту глаза не могут быть отведены… (куда?), то есть развивается паралич взора … (куда?) и их надъядерные пути."
                }
            ],
            answer: [
                {
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "68");
        }
    },
    methods: {
