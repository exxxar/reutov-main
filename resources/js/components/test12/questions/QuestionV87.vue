<template>
    <div class="test-block">
        ...
        <div class="test-main test-main-84 test-exercise-in-topical-diagnostic">
            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>Дано:</b>
                        <br />1. Очаг поражения – в левой половине моста.
                        <br />2. Очаг поражения – в большом полушарии справа.
                    </p>
                </div>
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test69.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block">
                    <div class="test-explanation test-explanation-desc">
                        <p class="explanation-txt">
                            <b>Дано:</b>
                            <br />1. Очаг поражения – в левой половине моста.
                            <br />2. Очаг поражения – в большом полушарии
                            справа.
                        </p>
                    </div>
...
export default {
            ...
            answers: [
                {
                    ...
                    symbol: "А",
                    result: null,
                    description: "Где будет атаксия? "
                },
                {
                    correct: "справа",
                    symbol: "Б",
                    result: null,
                    description: "На какой стороне разовьются параличи?"
                }
            ]
        };
    },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "87");
        }
    }
};
</script>
