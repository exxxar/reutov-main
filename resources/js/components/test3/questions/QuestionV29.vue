            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>ДАНО</b><br />
                        полное поперечное поражение спинного мозга на уровне
                        С5-С6.
                    </p>
                </div>
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test31.png'"
                        alt="courses"
                    />
                </div>
                <div class="compliance-block" style="margin-left: 20px">
                    ...
                    <p class="compliance-txt">
                        А) Определите: сначала патологию рефлексов, а затем на
                        этой основе сформулируйте синдромы параличей верхних
                        конечностей, нижних конечностей, тазовых органов.
                    </p>
...
export default {
            ...
            answer: [
                {
                    result: null,
                    correct: [
                        "Верхняя смешанная параплегия",
                        "Нижняя центральная параплегия",
                        "Центральный паралич органов малого таза, или нарушение функций тазовых органов по центральному типу"
                    ]
                },
                {
                    result: 0,
    ...
    methods: {
        ...
        correctGroups(item) {
            ...
            this.answer[0].correct.forEach(element => {
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "29");
        }
    }
};
</script>
