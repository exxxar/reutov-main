            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>ДАНО</b><br />
                        патологический процесс локализован в нижних отделах
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test9.png'"
                        alt="courses"
                    />
                </div>
...
export default {
        ...
        return {
            ...
            answer: [
                ...
                },
                {
                    result: "",
                    correct:
                        "Синдром центральной моноплегии правой руки, или синдром неравномерного центрального правостороннего гемипареза (с плегией в руке)."
                },
                {
                    result: 0,
                    correct: 1
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "21");
        }
    }
};
</script>
