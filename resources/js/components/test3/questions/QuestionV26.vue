        ...
        <div class="test-main test-exercise-in-topical-diagnostics">
            ...
            <div class="test-compliance">
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test28.png'"
                        alt="courses"
                    />
                </div>
...
export default {
        ...
        return {
            answers: [
                ...
                },
                {
                    ...
                    symbol: "Б",
                    description:
                        " Характер паралича ног. (В том, что в ногах разовьется паралич, вы, конечно, не сомневаетесь?)",
                    order: 1
                },
                {
                    part: 1,
                    symbol: "В",
                    description: " В каком состоянии функция тазовых органов?",
                    order: 2
                }
            ],
            answer: [
                ...
                {
                    result: "",
                    correct: "Периферический паралич тазовых органов"
                }
            ]
        };
    },
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "26");
        }
    }
};
</script>
