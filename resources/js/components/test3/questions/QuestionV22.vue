        ...
        <div class="test-main test-exercise-in-topical-diagnostics">
            ...
            <div class="test-compliance">
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test24.png'"
                        alt="courses"
                    />
                </div>
...
export default {
        ...
        return {
            answers: [
                ...
                },
                {
                    ...
                    symbol: "Б",
                    description:
                        " Сформулируйте синдром нарушений произвольных движений",
                    order: 1
                },
                {
                    part: 1,
                    symbol: "В",
                    description:
                        " Укажите характер нарушения функций тазовых органов",
                    order: 2
                }
            ],
            answer: [
                ...
                },
                {
                    result: "",
                    correct:
                        "Центральная тетраплегия с нарушением функций тазовых органов по центральному типу."
                },
                {
                    result: "",
                    correct:
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "22");
        }
    }
};
</script>
