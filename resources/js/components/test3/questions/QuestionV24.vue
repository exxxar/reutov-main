            ...
            <div class="test-compliance">
                <div class="test-explanation test-explanation-mob">
                    <p class="explanation-txt">
                        <b>ДАНО</b><br />
                        у больного на уровне Th3 имеется поражение правой
                ...
                <div class="compliance-img">
                    <img
                        :src="currentUrl + '/test-img/test26.png'"
                        alt="courses"
                    />
                </div>
...
export default {
        ...
        return {
            answers: [
                ...
                },
                {
                    ...
                    symbol: "Б",
                    description:
                        " Сформулируйте синдром нарушения произвольных движений",
                    result: null
                },
                {
                    part: 2,
            ...
            answer: [
                ...
                {
                    result: "",
                    correct: "Нижний центральный монопарез справа (моноплегия)."
                },
                {
                    result: 0,
                    correct: 1
    ...
    computed: {
        currentQuestionAnswers() {
            ...
            return this.serverAnswers.find(x => x.question_index == "24");
        }
    }
};
</script>
