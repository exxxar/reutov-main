...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Добавление главы курса "{{$course->title}}"</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        @if ($errors->any())
    ...
    <section class="content">
        <form method="post" action="{{ route('chapter.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <a href="{{ route('course.chapters', $course['id']) }}" class="btn btn-secondary">Назад</a>
                    <input type="submit" value="Добавить главу" class="btn btn-success float-right">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
