...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Редактирование теста главы "{{$chapter->title}}"</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        @if ($errors->any())
    ...
    <section class="content">
        <form method="post" action="{{ route('test.update', $test['id']) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <a href="{{ route('chapter.tests', $test->chapter->id) }}" class="btn btn-secondary">Назад</a>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input value="{{ $test->min_correct }}" name="min_correct" type="number" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Продолжительность (мин)</label>
                                <input value="{{ $test->minutes }}" name="minutes" type="number" class="form-control">
                            </div>
